...
INSERT INTO "estados_fabricacion" ("id","nombre","slug","orden","color","es_final","created_at") VALUES(1,'Pendiente','pendiente',0,'warning',0,NULL);
INSERT INTO "estados_fabricacion" ("id","nombre","slug","orden","color","es_final","created_at") VALUES(2,'Cortando','cortando',1,'info',0,NULL);
INSERT INTO "estados_fabricacion" ("id","nombre","slug","orden","color","es_final","created_at") VALUES(3,'Curvando','curvando',2,'info',0,NULL);
INSERT INTO "estados_fabricacion" ("id","nombre","slug","orden","color","es_final","created_at") VALUES(4,'Soldando','soldando',3,'info',0,NULL);
INSERT INTO "estados_fabricacion" ("id","nombre","slug","orden","color","es_final","created_at") VALUES(5,'Puliendo','puliendo',4,'info',0,NULL);
INSERT INTO "estados_fabricacion" ("id","nombre","slug","orden","color","es_final","created_at") VALUES(6,'Terminado','terminado',5,'success',1,NULL);
INSERT INTO "estados_fabricacion" ("id","nombre","slug","orden","color","es_final","created_at") VALUES(7,'Pausado','pausado',6,'error',0,NULL);
...
INSERT INTO "lineas_pedido" ("id","pedido_id","producto_id","es_personalizado","descripcion_personalizada","medidas_primario_diametro","medidas_primario_largo","medidas_secundario_diametro","medidas_secundario_largo","trombon_diametro_inicial","trombon_largo","trombon_observaciones","cantidad","precio_unitario","orden_linea","created_at","updated_at","orden_fabricacion_id") VALUES(6,4,13,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,144,NULL,1781707131,1781707131,NULL);
INSERT INTO "lineas_pedido" ("id","pedido_id","producto_id","es_personalizado","descripcion_personalizada","medidas_primario_diametro","medidas_primario_largo","medidas_secundario_diametro","medidas_secundario_largo","trombon_diametro_inicial","trombon_largo","trombon_observaciones","cantidad","precio_unitario","orden_linea","created_at","updated_at","orden_fabricacion_id") VALUES(7,4,11,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,4,444,NULL,1781707131,1781707131,NULL);
...
INSERT INTO "unidades_fabricacion" ("id","orden_fabricacion_id","numero_serie","estado_id","fecha_entrada_estado","es_defectuoso","defecto_descripcion","foto_urls","observaciones","created_at","updated_at") VALUES(5,1,'1-001',1,1781750018,0,NULL,NULL,NULL,1781750018,1781750018);
INSERT INTO "unidades_fabricacion" ("id","orden_fabricacion_id","numero_serie","estado_id","fecha_entrada_estado","es_defectuoso","defecto_descripcion","foto_urls","observaciones","created_at","updated_at") VALUES(6,2,'2-001',1,1781751444,0,NULL,NULL,NULL,1781751444,1781751444);
INSERT INTO "unidades_fabricacion" ("id","orden_fabricacion_id","numero_serie","estado_id","fecha_entrada_estado","es_defectuoso","defecto_descripcion","foto_urls","observaciones","created_at","updated_at") VALUES(7,2,'2-002',1,1781751444,0,NULL,NULL,NULL,1781751444,1781751444);
...
INSERT INTO "pedidos" ("id","numero_pedido","cliente_id","fecha_pedido","fecha_entrega_prometida","fecha_entrega_real","estado_id","precio_total","anticipo","saldo_pendiente","observaciones","created_at","updated_at") VALUES(4,'P-00002',2,1781707130,1781913600,NULL,1,2064,433,1631,'SARASA',1781707130,1781707130);
...
INSERT INTO "ordenes_fabricacion" ("id","nombre_trabajo","cantidad_total","cantidad_producida","cantidad_defectuosa","estado_id","prioridad","fecha_inicio","fecha_fin_estimada","fecha_fin_real","asignado_a","observaciones","created_at","updated_at") VALUES(1,'ADASD',1,0,0,1,2,NULL,1781913600,NULL,NULL,'',1781750018,1781750018);
INSERT INTO "ordenes_fabricacion" ("id","nombre_trabajo","cantidad_total","cantidad_producida","cantidad_defectuosa","estado_id","prioridad","fecha_inicio","fecha_fin_estimada","fecha_fin_real","asignado_a","observaciones","created_at","updated_at") VALUES(2,'asdasdasd',2,0,0,1,0,NULL,NULL,NULL,NULL,'',1781751443,1781751443);
CREATE TABLE acciones_fabricacion (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  nombre TEXT NOT NULL UNIQUE,
  estado_origen_id INTEGER REFERENCES estados_fabricacion(id),
  estado_destino_id INTEGER NOT NULL REFERENCES estados_fabricacion(id)
);
INSERT INTO "acciones_fabricacion" ("id","nombre","estado_origen_id","estado_destino_id") VALUES(1,'Iniciar Corte',1,2);
INSERT INTO "acciones_fabricacion" ("id","nombre","estado_origen_id","estado_destino_id") VALUES(2,'Iniciar Curvado',2,3);
INSERT INTO "acciones_fabricacion" ("id","nombre","estado_origen_id","estado_destino_id") VALUES(3,'Iniciar Soldadura',3,4);
INSERT INTO "acciones_fabricacion" ("id","nombre","estado_origen_id","estado_destino_id") VALUES(4,'Iniciar Pulido',4,5);
INSERT INTO "acciones_fabricacion" ("id","nombre","estado_origen_id","estado_destino_id") VALUES(5,'Terminar',5,6);
INSERT INTO "acciones_fabricacion" ("id","nombre","estado_origen_id","estado_destino_id") VALUES(6,'Pausar',NULL,7);
DELETE FROM sqlite_sequence;
INSERT INTO "sqlite_sequence" ("name","seq") VALUES('d1_migrations',10);
...
INSERT INTO "sqlite_sequence" ("name","seq") VALUES('unidades_fabricacion',7);
INSERT INTO "sqlite_sequence" ("name","seq") VALUES('ordenes_fabricacion',2);
